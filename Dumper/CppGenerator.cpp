...
void CppGenerator::WriteFileHead(StreamType& File, const std::string& PackageName, EFileType Type)
{
...
// Package: {}
	...
	{
		// include "Basic.hpp" in case the functions don't include a param file
		File << "#include \"Basic.hpp\"\n\n";

		const bool bHasPackageParamFile = true;
		if (bHasPackageParamFile)
		{
