...
std::string IDAMappingV2Generator::GetStructPrefixedName(const StructWrapper& Struct)
{
...
std::string IDAMappingV2Generator::GetEnumPrefixedName(const EnumWrapper& Enum)
{
...
std::string IDAMappingV2Generator::GetIDACppTypeForProperty(UEProperty Property, bool& OutIsPtr)
{
	OutIsPtr = false;
...
void IDAMappingV2Generator::InitPredefinedMembers()
{
...
uint32_t IDAMappingV2Generator::GeneratePredefinedTypes(std::stringstream& StructData, std::stringstream& NameData)
{
...
void IDAMappingV2Generator::GenerateSingleMember(const PropertyWrapper& Member, std::stringstream& StructData, std::stringstream& NameData, int32 StructSize)
{
	bool bIsPtr = false;
...
void IDAMappingV2Generator::GenerateSingleEnum(const EnumWrapper& Enum, std::stringstream& EnumData, std::stringstream& NameData)
{
...
void IDAMappingV2Generator::GenerateVTableName(std::stringstream& ExecFuncData, std::stringstream& NameData, UEObject DefaultObject)
{
...
void IDAMappingV2Generator::GenerateClassFunctions(std::stringstream& ExecFuncData, std::stringstream& NameData, UEClass Class)
{
...
uint32_t IDAMappingV2Generator::GenerateInternalEnums(std::stringstream& EnumData, std::stringstream& NameData)
{
