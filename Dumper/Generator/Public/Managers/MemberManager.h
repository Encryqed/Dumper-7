...
public:
	...
	inline FunctionIterator end() const { return FunctionIterator(Struct, Members, PredefElements, static_cast<int32>(Members.size()), PredefElements ? static_cast<int>(PredefElements->size()) : 0x0); }
};
