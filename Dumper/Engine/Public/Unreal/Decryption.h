...
namespace Decryption
{
	...
	inline uint8_t* (*FField_EditorOnlyMetadata)(const void* MemberAddress)             = [](const void* MemberAddress) -> uint8_t* { return static_cast<uint8_t*>(*reinterpret_cast<void* const*>(MemberAddress)); };
...
#define DECRYPT_FField_EditorOnlyMetadata(L)             (Decryption::FField_EditorOnlyMetadata = (L));
