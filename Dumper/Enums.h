...
{																															\
	return (EEnumClass)((__underlying_type(EEnumClass))(Left) | (__underlying_type(EEnumClass))(Right));					\
}																															\
																															\
inline constexpr EEnumClass operator&(EEnumClass Left, EEnumClass Right)													\
{																															\
...
{																															\
	return ((__underlying_type(EEnumClass))(Left) & (__underlying_type(EEnumClass))(Right)) == __underlying_type(EEnumClass))(Right);					\
}

enum class EStructFlags : uint32_t
{
	NoFlags = 0x00000000,
